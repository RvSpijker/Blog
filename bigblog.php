<?php 
    ...
    $dbconnect = new dbconnection();
    $sql = "SELECT comments.text, users.username FROM `comments` INNER JOIN users ON users.id=comments.user_id WHERE blog_id = '$blog_id'"; 
    $query = $dbconnect -> prepare($sql);
    $query -> execute();
        ...
        <div class="bigmainblog">
            ...
            <form class="plc-commentdiv" action="src/formhandlers/comment.php" method="POST">
                <div class="grid-container3">
                    <img class="item8 plc-commentimg" src="img/user.png" alt="user">
